...
Personal [Cursor](https://cursor.com) **rules** (`.cursor/rules/`) and **skills** (`.cursor/skills/`) for AI-assisted dev: Go, K8s, security habits, MCP/skill tooling, etc.
...
**Rule hygiene check:** run `./scripts/audit-rules.sh` to catch common rule quality issues (missing frontmatter/description, accidental `copy` files, tracked `local-context.mdc`).
