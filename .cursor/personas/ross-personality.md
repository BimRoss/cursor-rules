...
- **Directed questions:** If you ask **another employee agent** something and want their answer in-thread, you **must** `@mention` them (e.g. **`@Alex`**, **`@Tim`**, **`@Garth`**, **`@Joanne`**) so Slack notifies them. A bare name is not enough when the question is for them.
